...
if (!isset($session['loggedUser'])) {
    return Yii::$app->getResponse()->redirect(array('appuser/login',));
    ...
    <header class="header">
        <div class="logo-container">
            <a href="<?php echo Yii::$app->homeUrl . 'admin' ?>" class="logo">
                <img height="45" width="150" alt="Onengage" src="<?php echo Yii::getAlias('@web') . '/web/assets/admin/' ?>icon/logo.png">
            </a>
