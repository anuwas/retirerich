...
<div class="row" id="tblForPrint">
    <div class="col-md-12 text-center">
        ...
        <h5 style="font-size:22px; color:#222; font-weight:500; padding:0; margin:0;">Invoice</h5>
    </div>
    ...
    <table class="table table-bordered" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;">Rate per Night (<?=$booking->currency?>)</td>
        ...
        <tr>
            ...
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;">Total Booking Value (<?=$booking->currency?>)</td>
        ...
        <tr>
            ...
            <?php  if($booking->currency == $invoice_currency){?>
        ...
        <tr>
            ...
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;">Total Booking Value(<?=$booking->currency?>)<b><?php if($booking->currency  =='INR'){echo "[".$agent."]" ;}?></b></td>
        ...
        <tr>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;">Booking Fee (<?=$booking->currency?>)</td>
        ...
        <tr>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;" rowspan="3">Venue Address</td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;" rowspan="3"><?php echo $booking->hotel->address;?><br><?php echo $booking->hotel->address_other;?></td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;">Value incl Booking Fee (<?=$booking->currency?>)</td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;"><?php
        ...
        <tr>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;">Extra Charges (<?=$booking->currency?>)</td>
        ...
        <tr>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;">Net Invoice Value (<?=$booking->currency?>)</td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;">
        ...
        <?php if($booking->currency  =='INR'){?>
            <tr>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;"></td>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;"></td>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;">SGST (<?php echo $sgst;?> %)</td>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;">-<?php //echo $model->sgst;?></td>
            </tr>
            <tr>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;"></td>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;"></td>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;">CGST (<?php echo $cgst;?> %)</td>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;">-<?php //echo $model->cgst;?></td>
            </tr>
            <tr>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;"></td>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;"></td>
        ...
        <tr>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;"></td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;"></td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;">Gross Invoice Value (<?=$booking->currency ?>)</td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;"><?php //echo $model->total;?>
                <?php if($booking->currency  =='INR'){$grossVAL = round($netinvoice,2) + round($finaligst,2);}
        ...
        <tr>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;"></td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;"></td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;">(rounded off to nearest <?=$booking->currency?>.)</td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px; background: #f2f2f2;"></td>
        </tr>
        <tr>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;" colspan="2">Net Amt. Payable (<?=$booking->currency?>) in word:</td>
            <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; padding-top: 4px;" colspan="2">
                ...
                echo "<b>".ucfirst($result). $booking->currency." </b> ";
                ?>
