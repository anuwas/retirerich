                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="Enter Name" name="ProductCategory[name]" id="productcategory-name" required  pattern="[A-Za-z ]+" title="Only Text Allow">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                            ...
                            <input name="submit" id="submit" value="Submit" type="submit" class="btn bg-deep-purple">
