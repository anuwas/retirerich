        ...
        <div class="block-header">
		 ...
		 <br>-->
            <ol class="breadcrumb breadcrumb-bg-white breadcrumb-col-deep-purple">
                ...
                <li><a href="javascript:void(0);"><i class="material-icons">library_books</i> Service</a></li>
            </ol>
                ...
                <div class="card">
                    <div class="header">
                       ...
                       <!-- <ul class="header-dropdown m-r--5">
                        ...
                        <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/product-category/newproductcategory" class="btn bg-deep-purple waves-effect" style="margin-top: -43px;"><i class="material-icons">add</i> ADD</a>                </div>
                    </div>
                    <div class="body">
	                    <?php $form = ActiveForm::begin(['action' =>['product-category/bulkdelete'], 'id' => 'pcbulkdelete', 'method' => 'post',],['options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
                            ...
                            <table class="table  table-striped table-hover dataTable js-exportable">
                                ...
                                foreach ($model as $value) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><img alt="" src="<?php echo Yii::getAlias('@web').'/uploads/product_category/'.$value->filename;?>" width="40px;"></td>
                                        ...
                                        <td>
                                            <a href="<?php echo Yii::$app->homeUrl.'admin/product-category/updateproductcategory?id='.$value->id;?>" class="btn bg-deep-purple btn-circle waves-effect waves-circle waves-light waves-float" title="EDIT"><i class="material-icons">edit</i></a> | <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/product-category/deleteproductcategory?id=<?php echo $value->id;?>" onClick="return confirm('Are you sure you want to delete?');" class="btn bg-deep-purple btn-circle waves-effect waves-circle waves-light waves-float" title="DELETE"><i class="material-icons">delete</i></a></td>
