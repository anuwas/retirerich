...
<nav class="navbar">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#"><img src="<?php echo Yii::getAlias('@web').'/web/assets/admin/'?>img/logo-p.png"  alt="Hyatt" height="32px"></a>
		</div>
	...
	<aside id="leftsidebar" class="sidebar">
		...
		<div class="menu">
			<ul class="list">
				...
				<li <?php if(strstr($_SERVER['REQUEST_URI'],"hotel") || strstr($_SERVER['REQUEST_URI'],"administrator")){ ?>class="active"<?php }?>>
					...
					<ul class="ml-menu">
						...
						<li>
							<a href="<?php echo Yii::$app->homeUrl . 'admin/administrator/list' ?>">Users</a>
						</li>
					</ul>
				</li>
				<li>
...
<script src="<?php echo Yii::getAlias('@web') . '/web/assets/admin' ?>/plugins/flot-charts/jquery.flot.js"></script>
<script src="<?php echo Yii::getAlias('@web') . '/web/assets/admin' ?>/plugins/flot-charts/jquery.flot.resize.js"></script>
<script src="<?php echo Yii::getAlias('@web') . '/web/assets/admin' ?>/plugins/flot-charts/jquery.flot.pie.js"></script>
<script src="<?php echo Yii::getAlias('@web') . '/web/assets/admin' ?>/plugins/flot-charts/jquery.flot.categories.js"></script>
<script src="<?php echo Yii::getAlias('@web') . '/web/assets/admin' ?>/plugins/flot-charts/jquery.flot.time.js"></script>

<script src="<?php echo Yii::getAlias('@web') . '/web/assets/admin' ?>/js/pages/index.js"></script>
