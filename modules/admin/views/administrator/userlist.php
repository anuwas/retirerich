                ...
                <div class="card">
                    <div class="header">
                       ...
                       <!-- <ul class="header-dropdown m-r--5">
                        ...
                        <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/administrator/adduser" class="btn bg-deep-purple waves-effect" style="margin-top: -43px;"><i class="material-icons">add</i> ADD</a>
                    </div>
                    </div>
                    <div class="body">
	                    <?php $form = ActiveForm::begin(['action' =>['administrator/bulkdelete'], 'id' => 'administratorbulkdelete', 'method' => 'post',],['options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
                        <div class="table-responsive">
                            <table class="table  table-striped table-hover dataTable js-exportable">
                                ...
                                foreach ($model as $value) {
                                    ...
                                    <tr class="odd gradeX">
                                        <td><?php echo $i;?></td>
                                        <td align="center"><input type="checkbox" name="checked_id[]" id="md_checkbox_2<?php echo $i;?>" class="checkbox" value="<?php echo $value->administratorid; ?>"/><label for="md_checkbox_2<?php echo $i;?>"></label></td>
                                        ...
                                        <td>
                                            <a href="<?php echo Yii::$app->homeUrl.'admin/administrator/editprofile?id='.$value->administratorid;?>" class="btn bg-deep-purple btn-circle waves-effect waves-circle waves-light waves-float" title="EDIT"><i class="material-icons">edit</i></a> | <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/administrator/deleteuser?id=<?php echo $value->administratorid;?>" onClick="return confirm('Are you sure you want to delete?');" class="btn bg-deep-purple btn-circle waves-effect waves-circle waves-light waves-float" title="DELETE"><i class="material-icons">delete</i></a></td>
