        ...
        <div class="block-header">
		 ...
		 <br>-->
            <ol class="breadcrumb breadcrumb-bg-white breadcrumb-col-deep-purple">
                ...
                <li><a href="javascript:void(0);"><i class="material-icons">library_books</i> Fund</a></li>
            </ol>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
	                    <?php $form = ActiveForm::begin(['action' =>['fund/bulkdelete'], 'id' => 'pcbulkdelete', 'method' => 'post',],['options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
                            ...
                            <table class="table  table-striped table-hover dataTable js-exportable">
                                ...
                                foreach ($model as $value) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $value->year_limit;?></td>
                                        ...
                                        <td>
                                            <a href="<?php echo Yii::$app->homeUrl.'admin/fund/updatefund?id='.$value->id;?>" class="btn bg-deep-purple btn-circle waves-effect waves-circle waves-light waves-float" title="EDIT"><i class="material-icons">edit</i></a> | <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/fund/deletefund?id=<?php echo $value->id;?>" onClick="return confirm('Are you sure you want to delete?');" class="btn bg-deep-purple btn-circle waves-effect waves-circle waves-light waves-float" title="DELETE"><i class="material-icons">delete</i></a></td>
