                    ...
                    <div class="header">
                       ...
                       <!-- <ul class="header-dropdown m-r--5">
                        ...
                        <button class="btn bg-deep-purple waves-effect" id="bulk" style="margin-top: -43px;"><i class="material-icons">delete</i> Bulk Delete</button>
                           <!-- <a href="<?php /*echo Yii::$app->request->baseUrl; */?>/admin/customer-master/importuser" class="btn bg-deep-purple waves-effect" style="margin-top: -43px;"><i class="material-icons">file_upload</i> Import</a>
                        <a href="<?php /*echo  Yii::$app->request->baseUrl;*/?>/admin/customer-master/newappuser" class="btn bg-deep-purple waves-effect" style="margin-top: -43px;"><i class="material-icons">add</i> ADD</a>-->
                    </div>
                    </div>
                    <div class="body">
	                    <?php $form = ActiveForm::begin(['action' =>['customer-master/bulkdelete'], 'id' => 'appuserbulkdelete', 'method' => 'post',],['options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
                            ...
                            <table class="table  table-striped table-hover dataTable js-exportable">
                                ...
                                foreach ($model as $value) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="<?php echo Yii::$app->homeUrl.'admin/customer-master/updatecustomer?id='.$value->id;?>" class="btn bg-deep-purple btn-circle waves-effect waves-circle waves-light waves-float" title="EDIT"><i class="material-icons">edit</i></a> | <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/customer-master/deletecustomer?id=<?php echo $value->id;?>" onClick="return confirm('Are you sure you want to delete?');" class="btn bg-deep-purple btn-circle waves-effect waves-circle waves-light waves-float" title="DELETE"><i class="material-icons">delete</i></a></td>
